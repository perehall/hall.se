...
.historical-coach{margin-top:7px}.historical-coach>summary{cursor:pointer;list-style:none;color:#7c3aed;font-size:.76rem;font-weight:800}.historical-coach>summary::-webkit-details-marker{display:none}.historical-coach>summary:after{content:" +"}.historical-coach[open]>summary:after{content:" −"}.historical-coach .coach{margin-top:7px}
...
def apply_signal_ui(page, strength_template, *, plan=None, activities=None, today=None):
    ...
    if plan is not None and today is not None:
        ...
        page = wrap_historical_coaches(page, plan, activities or [], today)
