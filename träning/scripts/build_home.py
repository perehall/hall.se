...
def render_performance_goals(goal, today=None):
    ...
    for item in items:
        ...
        rows.append(
            ...
            f'<div class="performance-goal-kicker">{esc(sport.upper() if sport else "PRESTATIONSMÅL")}</div>'
    ...
    return (
        ...
        '<div class="title">Konkreta prestationsmål</div>'
        + "".join(rows)
        + '</section>'
    )
