...
def render_performance_goals(goal):
    items = [
    ...
    for item in items:
        ...
        heading = " · ".join(part for part in (event, year) if part)
        rows.append(
...
def build_goal_page(goal, strategy, today):
    ...
    performance_goals = render_performance_goals(goal)
