...
class RenderPipelineTests(unittest.TestCase):
    def test_pipeline_order_is_single_explicit_contract(self):
        ...
        self.assertLess(PIPELINE.index("finalize_completed_workout_truth.py"), PIPELINE.index("finalize_coach_clarity_ui.py"))
        self.assertLess(PIPELINE.index("finalize_coach_clarity_ui.py"), PIPELINE.index("build_home.py"))
